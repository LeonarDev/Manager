    ...
    public class UserValidator : AbstractValidator<User>
    {
        public UserValidator()
        {
            ...
            RuleFor(x => x.Password)
                .NotEmpty()
                .WithMessage("A password não pode ser vazia.")
                
                .NotNull()
                .WithMessage("A password não pode ser nula.")

                .MinimumLength(6)
                .WithMessage("A password deve conter no mínimo 6 caracteres.")

                .MaximumLength(20)
                .WithMessage("A password deve conter no máximo 20 caracteres");
        }
    }
}